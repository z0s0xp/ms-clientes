...
* The original package name 'common.ms-clientes' is invalid and this project uses 'common.msclientes' instead.
...
* [Jersey](https://docs.spring.io/spring-boot/docs/2.7.15/reference/htmlsingle/index.html#web.servlet.jersey)
